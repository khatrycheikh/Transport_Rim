...
namespace TransportRim.Api.Data
{
    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(TransportRimDbContext context)
        {
            ...
            if (!await context.Users.AnyAsync(u => u.PhoneNumber == "36100001"))
            {
                var admin = new User
                {
                    Name = "Administrateur Système",
                    PhoneNumber = "36100001",
            ...
            if (!await context.Users.AnyAsync(u => u.PhoneNumber == "36100002"))
            {
                var traveler = new User
                {
                    Name = "Cheikh Traveler",
                    PhoneNumber = "36100002",
