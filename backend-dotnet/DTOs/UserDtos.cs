...
{
    /// <summary>
    /// Représente les informations détaillées d'un utilisateur renvoyées par l'API.
    /// </summary>
    ...
    /// <summary>
    /// DTO pour la mise à jour des informations d'un utilisateur par un administrateur.
    /// </summary>
    public class UpdateUserDto
    {
        ...
        [StringLength(100, MinimumLength = 6, ErrorMessage = "Le mot de passe doit contenir au moins 6 caractères.")]
        public string? Password { get; set; } // Optionnel : pour réinitialisation
    }
}
