    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequestDto request)
        {
            try
            {
                ...
                if (result == null)
                {
                    return Conflict(new { message = "L'adresse email saisie est déjà associée à un compte." });
                }
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestDto request)
        {
            ...
            if (result == null)
            {
                return Unauthorized(new { message = "L'adresse email ou le mot de passe est incorrect." });
            }
